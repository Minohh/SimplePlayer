...
int VideoFilterInit(Codec *c){
    ...
    AVFilterContext *my_video_filter1 = NULL;
    AVFilterContext *my_video_filter2 = NULL;
    AVFilterContext *my_video_filter3 = NULL;
    AVFilterContext *my_video_filter4 = NULL;
    AVFilterContext *internal_video_filter = NULL;
    AVFilterContext *overlay_video_filter = NULL;
    AVFilterContext *testsrc_video_filter = NULL;
    AVFilterContext *swapuv_video_filter = NULL;
    AVFilterGraph *filter_graph = NULL;

    const AVFilter *buffersrc  = avfilter_get_by_name("buffer");
    const AVFilter *buffersink = avfilter_get_by_name("buffersink");
    const AVFilter *overlay    = avfilter_get_by_name("overlay");
    const AVFilter *testsrc    = avfilter_get_by_name("testsrc");
    const AVFilter *swapuv     = avfilter_get_by_name("swapuv");

    extern AVFilter ff_f_test;
    const AVFilter *myfilter   = &ff_f_test;
    ...
    avfilter_graph_create_filter(&my_video_filter1, myfilter, "test1", NULL, NULL, filter_graph);
    avfilter_graph_create_filter(&my_video_filter2, myfilter, "test2", NULL, NULL, filter_graph);
    avfilter_graph_create_filter(&my_video_filter3, myfilter, "test3", NULL, NULL, filter_graph);
    avfilter_graph_create_filter(&my_video_filter4, myfilter, "test4", NULL, NULL, filter_graph);
    
    //avfilter_graph_create_filter(&internal_video_filter, myfilter, "internal", NULL, NULL, filter_graph);

    avfilter_graph_create_filter(&overlay_video_filter, overlay, "overlay", NULL, NULL, filter_graph);
    avfilter_graph_create_filter(&testsrc_video_filter, testsrc, "testsrc", "rate=120", NULL, filter_graph);
    //avfilter_graph_create_filter(&swapuv_video_filter, swapuv, "swapuv", NULL, NULL, filter_graph);
    
    filter = my_video_filter3;
    //av_opt_set(testsrc_video_filter, "duration", "10", AV_OPT_SEARCH_CHILDREN); 
    av_opt_show2(in_video_filter->priv, NULL, 8|(1<<16), 0);
    av_opt_show2(out_video_filter->priv, NULL, 8|(1<<16), 0);

    avfilter_link(in_video_filter, 0, my_video_filter1, 0);
    avfilter_link(my_video_filter1, 0, my_video_filter2, 0);
    avfilter_link(my_video_filter2, 0, overlay_video_filter, 0);

    avfilter_link(testsrc_video_filter, 0, overlay_video_filter, 1);
    //avfilter_link(testsrc_video_filter, 0, swapuv_video_filter, 0);
    //avfilter_link(testsrc_video_filter, 0, internal_video_filter, 0);
    //avfilter_link(internal_video_filter, 0, swapuv_video_filter, 0);
    //avfilter_link(swapuv_video_filter, 0, overlay_video_filter, 1);
    
    avfilter_link(overlay_video_filter, 0, my_video_filter3, 0);
    avfilter_link(my_video_filter3, 0, my_video_filter4, 0);
    avfilter_link(my_video_filter4, 0, out_video_filter, 0);
